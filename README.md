...
O projeto desenvolve processos de gestão, manuais, templates e protocolos para o portal Webmuseu (Portal Acadêmico da Professora) e para o LavMUSEU (Laboratório Virtual da ECI/UFMG), disponibilizando estes recursos para o público em geral no GitHub.
